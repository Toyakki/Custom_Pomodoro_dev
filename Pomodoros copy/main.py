...
def pomodoro_timer():
    ...
    BACKDROP = pygame.image.load("Pomodoros/Backdrop.png")
    WHITE_BUTTON = pygame.image.load("Pomodoros/button.png")

    FONT = pygame.font.Font("Pomodoros/ArialRoundedMTBold.ttf", 120)
    ...
    START_STOP_BUTTON = Button(WHITE_BUTTON, (WIDTH/2, HEIGHT/2+100), 170, 60, "START", 
                        pygame.font.Font("Pomodoros/ArialRoundedMtBold.ttf", 20), "#808080", "#808080")
    ...
    POMODORO_LENGTH = 3  # 5400 secs / 90 mins
    ...
    alarm_sound = pygame.mixer.Sound("Pomodoros/337756-Japanese_ambience_-water_trickling_from_a_pond_and_crickets_during_night_time_-traffic_noise_in_the_distance_-seamles.wav")
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if started:
                    ...
                    START_STOP_BUTTON.text = pygame.font.Font("Pomodoros/ArialRoundedMtBold.ttf", 20).render(
